...
<div class="smstop">
    ...
    <tr>
      ...
      <td>
        <a href="#"><img src="images/sms/cjbtn.png" alt="幸运大转盘" title="幸运大转盘" /></a>
      </td>
      <td>
        <a href="<%=path%>/customQuestion.jsp"><img src="images/sms/dtbtn_gray.png" alt="短信抢答" title="短信抢答"  onmouseover="activatePic(3, this)" onmouseout="bgPic(3, this)"/></a>
      </td>
    </tr>
  </table>
          </div>
...
<div class="Preview"></div>
  ...
  <div class="smsright">
    <div class="lott_begin">
      ...
      <div class="btn_begin">
        <input type="button" style="width:219px; height:48px; background:url(images/sms/lott_begin.png); border:none;" onclick="startExt()" id="startBtn"/>
      </div>
    </div>
    <div class="lott_list">
    <table border="0" cellspacing="1" cellpadding="0">
      ...
      <div class="btn_list">
        <input type="button" style="width:168px; height:37px; background:url(images/sms/lott_up.png); border:none;" onclick="previousPage()" />
        <input type="button" style="width:168px; height:37px; background:url(images/sms/lott_down.png); border:none;" onclick="nextPage()" />
      </div>
    </div>
  </div>
