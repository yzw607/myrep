...
List list = (List)request.getAttribute("numberList");
String firstNumber = "";
if(list != null && list.size() > 0) firstNumber = (String)list.get(0);

List list2 = null == request.getAttribute("setList") ? new ArrayList() : (List)request.getAttribute("setList");
...
{
    number = (LotteryNumber)list2.get(i);
