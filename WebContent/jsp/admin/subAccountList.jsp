...
{
  window.location.href = "<%=path%>/querySubAccountInfo.action?subAccount.userId=" + id;
}
    ...
    <div class="maincontent noright">
      <div class="maincontentinner">
        <ul class="maintabmenu">
          <li class="current"><a href="#">子账户管理</a></li>
        </ul>
        <!--maintabmenu-->
        
        <div class="content">
          <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>子账户列表</span></h2>
          </div>
          <!--contenttitle-->
          <div class="dataTables_wrapper" id="dyntable_wrapper">
          
          <s:form action="subAccount" method="post" theme="simple">
          <s:hidden name="page.indexPage" id="indexPage"></s:hidden>
            <div id="dyntable_length" class="dataTables_length">
              子账户账号：<s:textfield name="subAccount.userCode" cssStyle="width:120px;"></s:textfield>
             &nbsp;&nbsp;
              子账户公司：<s:textfield name="subAccount.companyName" cssStyle="width:120px;"></s:textfield>
             &nbsp;&nbsp;
              联系人：<s:textfield name="subAccount.userName" cssStyle="width:120px;"></s:textfield>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <input type="button" value="搜索" class="stdbtn btn_yellow" style="width:80px;" onclick="doSearch()"/>
              <input type="button" class="stdbtn btn_yellow" style="width:80px;" value="新增子账户" onclick="javascript:window.location.href='<%=path%>/goNewSubAccount.action';"/>
            </div>
          </s:form>
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
              <thead>
                <tr>
                  <th class="head1" rowspan="1" colspan="1">子账户账号</th>
                  <th class="head1" rowspan="1" colspan="1">子账户公司</th>
                  <th class="head0" rowspan="1" colspan="1">联系人</th>
                  <th class="head0" rowspan="1" colspan="1">联系电话</th>
                  <th class="head0" rowspan="1" colspan="1">剩余使用次数</th>
                </tr>
              </thead>
              <tbody>

<s:iterator value="#request.subAccountList" id="sub">
                        <tr class="gradeX" onclick="showSubAccount('${sub.userId}')">
                            <td title="${sub.userCode}" align="center">${sub.userCode}</td>
                            <td title="${sub.companyName}" align="center">${sub.companyName}</td>
                            <td title="${sub.userName}" align="center">${sub.userName}</td>
                            <td title="${sub.tel}" align="center">${sub.tel}</td>
                            <td align="center">${sub.remainingTime}</td>
                        </tr>
</s:iterator>
