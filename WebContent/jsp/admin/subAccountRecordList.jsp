...
function goBack()
{
  window.location.href="<%=path%>/querySubAccountInfo.action?subAccount.userId=${user.userId}";
}
</script>
...
<s:form action="querySubAccountRecord" method="post" theme="simple">
    ...
    <div class="maincontent noright">
      <div class="maincontentinner">
        ...
        <div style="margin:5px;">
          账户【${user.userCode}】剩余使用次数为：${user.remainingTime}次&nbsp;&nbsp;&nbsp;&nbsp;
                              <button class="stdbtn btn_yellow" onclick="goBack()">返回</button>
        </div>

          <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>子账户账单明细</span></h2>
          </div>
          <!--contenttitle-->
