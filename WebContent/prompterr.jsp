...
<s:if test="msgType == 'success'">
                <div class="promptpic_success" ></div>
</s:if>
<s:elseif test="msgType == 'error'">
                <div class="promptpic_error"></div>
</s:elseif>
<s:elseif test="msgType == 'alert'">
                <div class="promptpic_alert"></div>
</s:elseif>
<s:else>
                <div class="promptpic_info"></div>
</s:else>

            <div class="prompttxt1">${sysMsg}</div>
            </th>
              </tr>
              <tr>
